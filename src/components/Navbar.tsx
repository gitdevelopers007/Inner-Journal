...
import { Sparkles, LogOut, Plus, ShieldCheck, BookOpen, Layers } from 'lucide-react';
        ...
        {user ? (
          <div className="flex items-center gap-2.5 sm:gap-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-neutral-800 bg-amber-50 hover:bg-amber-100/80 border border-amber-200/70 rounded-lg shadow-xs transition-all active:scale-95 cursor-pointer"
            >
